...
func TestVerifyV3MessageWithSigProof_NonMerkalized(t *testing.T) {
	...
	userID := "did:polygonid:polygon:mumbai:2qGvSqi9rGvyEvYesfeqETtRsb9ZY54M3o68kLYKsA"
	responseUUID := uuid.New()
		...
		Scope: []protocol.ZeroKnowledgeProofResponse{
			{
				...
				ZKProof: types.ZKProof{
					Proof: &types.ProofData{
						A: []string{
							"2896097870744883045053249762222032294085620680320757194434653667430777951012",
							"14600686276664930900625810770610282120864655177023382965238910404423747686249",
							"1",
						},
						B: [][]string{
							{
								"8425144420030767231017914983073275330341643921561475653685121382102366887344",
								"9601321562070613403905825842906546025615561905146342874634265894080638070408",
							},
							{
								"15299720329665047898220410751513832370720363075729886763378591709587833955290",
								"6913342958568002502871687143976645666867784220430538618494969256583355143840",
							},
							{
								"1",
								"0",
						...
						C: []string{
							"13104137991449787545517712256435673035233109256870076671509665883769041319898",
							"4053229351935938653933420850218400809573397398312808294609759151919854243996",
							"1",
						},
						Protocol: "groth16",
					},
					PubSignals: []string{
						"0",
						"23459447489935028445379416846855540254039795149800112600469434636200710658",
						"8851059590368694288744264514345994224043358504372218120402252643567192431604",
						"0",
						"0",
						"0",
						"84239",
						"24405102646514203292848810389949964771472615548146331707337046820200911362",
						"1",
						"8851059590368694288744264514345994224043358504372218120402252643567192431604",
						"1698829002",
						"198285726510688200335207273836123338699",
...
func TestVerifyV3MessageWithMtpProof_Merkalized(t *testing.T) {
	...
	mtpProofRequest.Optional = &opt
	mtpProofRequest.Query = map[string]interface{}{
		"allowedIssuers": []string{"did:polygonid:polygon:mumbai:2qMkJfk7g7VTn38CdHRh8w4MnFEzcGqxyRE8Nijxya"},
		"credentialSubject": map[string]interface{}{
		...
		Scope: []protocol.ZeroKnowledgeProofResponse{
			{
				...
				ZKProof: types.ZKProof{
					Proof: &types.ProofData{
						A: []string{
							"2460662541861293139366873620037217200982164899859368534550751285046506158016",
							"8723776635882591276497540959978695062846105334124280793058304651995504990254",
							"1",
						},
						B: [][]string{
							{
								"10675434953304179940607731150127230085098825168661843115425722196596556705115",
								"2065051612697333749931628045548559621906540822909047516270210261308512662307",
							},
							{
								"14288797505264443872097853335009417816106336504373647696165284445760467511456",
								"19976719173368313644645142167541883212200085911125357264828832932631810938560",
							},
							{
								"1",
								"0",
						...
						C: []string{
							"2537946249841181833658626884088988369572054797377638347097795555823623273753",
							"235490623423235248146787869358939502844405416014382891741305477164118873878",
							"1",
						},
						Protocol: "groth16",
					},
					PubSignals: []string{
						...
						"24405102646514203292848810389949964771472615548146331707337046820200911362",
						"1",
						"7528004977781077784382157786229155832861320708256349034172352010962236556955",
						"1698829631",
