...
func TestVerifyV3MessageWithSigProof_NonMerkalized(t *testing.T) {
	...
	userID := "did:polygonid:polygon:mumbai:2qJhHewUsGr2UbX1nu5uvL3Pcb5bsCyjmY13qDGhuE"
	responseUUID := uuid.New()
...
func TestVerifyV3MessageWithMtpProof_Merkalized(t *testing.T) {
	...
	mtpProofRequest.Optional = &opt
	mtpProofRequest.Query = map[string]interface{}{
		"allowedIssuers": []string{"did:polygonid:polygon:mumbai:2qLvkstQ79ysCXmgF3gwLRPmG3zu87FUvHdWXuCaR2"},
		"credentialSubject": map[string]interface{}{
